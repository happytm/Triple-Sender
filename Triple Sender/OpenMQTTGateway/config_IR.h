...
extern void setupIR();
extern void IRtoSERIAL();  
extern void SERIALtoIR(char * topicOri, char * datacallback);
extern void SERIALtoIR(char * topicOri, JsonObject& RFdata);
/*-------------------IR topics & parameters----------------------*/
//IR MQTT Subjects
#define subjectGTWIRtoSERIAL  Base_Topic Gateway_Name "/IRtoSERIAL"
#define subjectIRtoSERIAL  Base_Topic Gateway_Name "/IRtoSERIAL"
#define subjectSERIALtoIR  Base_Topic Gateway_Name "/commands/SERIALtoIR"

// subject monitored to listen traffic processed by other gateways to store data and avoid ntuple
#define subjectMultiGTWIR "+/+/IRtoSERIAL"
