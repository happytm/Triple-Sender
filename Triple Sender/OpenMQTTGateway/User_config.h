...
/*-------------DEFINE YOUR  NETWORK PARAMETERS BELOW----------------*/
  ...
  #define ESPWifiManualSetup false //uncomment you don't want to use wifimanager for your credential settings on ESP
#endif
...
#define subjectMultiGTWKey "toSerial"
#define subjectGTWSendKey "Serialto"

//variables to avoid duplicates
#define time_avoid_duplicate 1000 // if you want to avoid duplicate mqtt message received set this to > 0, the value is the time in milliseconds during which we don't publish duplicates
...
#define subjectSYStoMQTT  Base_Topic Gateway_Name "/SYStoSerial"
